...
plt.title(f"Évolution de la température de confort à l'état stationnaire (∆t = {delta_t_optimal:.2f}h)", fontsize=22)
plt.grid(True)
...
plt.xlabel("Temps (jours)", fontsize=22)
plt.ylabel("Température de confort (°C)", fontsize=22)
plt.title(f"Évolution de la température de confort sur {nb_jours} jours (∆t = {delta_t_optimal:.2f}h)", fontsize=22)
plt.grid(True)
plt.legend(fontsize=22)
plt.show()

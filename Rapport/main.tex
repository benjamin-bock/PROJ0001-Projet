...
\section{Pertes et gains de chaleur}
    ...
    \subsection{Vérification graphique}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=1\linewidth]{Rapport/figures/PerteEtGain.png}
...
\section{Mise en place de la modélisation}
    \subsection{Encodage de \texttt{odefunction}}
        ...
        \begin{itemize}
            ...
            \item Sinon :
            Le dernier terme de l'équation \ref{eq:Tt} peut être rejeté.
        \end{itemize}
    ...
    \subsection{Méthode Runge-Kutta d'ordre 4/5}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=1\linewidth]{Rapport/figures/ComparaisonEulerRK45.png}
            \caption{Comparaison entre Euler et Runge-Kutta 45}
    ...
    \subsection{Convergence d'Euler en fonction du pas $h$}
        Une analyse de l'erreur en fonction du pas de temps $h$ a été réalisée en comparant la solution obtenue avec Euler à une solution de référence avec \texttt{solve\_ivp}.

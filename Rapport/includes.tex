...
\usepackage[french]{babel}  % Définit la langue du document en français
\usepackage{datetime2}  % Permet de gérer la date
\DTMsetdatestyle{french}  % Force le format français de la date
